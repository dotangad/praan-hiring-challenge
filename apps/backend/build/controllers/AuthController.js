...
exports.protectedRoute = exports.login = exports.register = void 0;
...
exports.login = [
    function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            passport_1.default.authenticate("login", function (err, user) { return __awaiter(void 0, void 0, void 0, function () {
                var error;
                return __generator(this, function (_a) {
                    try {
                        if (err || !user) {
                        ...
                        req.login(user, { session: false }, function (error) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                ...
                                token = jsonwebtoken_1.default.sign({ user: body }, (_a = process.env.JWT_SECRET) !== null && _a !== void 0 ? _a : "");
